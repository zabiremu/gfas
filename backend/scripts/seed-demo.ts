...
// The 4th group's leading hex digit is fixed to 'a' (RFC 4122 variant nibble
// must be 8/9/a/b) so these validate against class-validator's @IsUUID() —
// earlier all-same-digit IDs (e.g. ...-3333-3333-...) failed that check,
// blocking any body field (shipperId, consigneeId, warehouseId, etc.) that
// referenced a seeded row.
// ---------------------------------------------------------------------------
const TENANT_ID = '11111111-1111-1111-a111-111111111111';

const USER = {
  admin: '22222222-2222-2222-a222-222222222221',
  agent: '22222222-2222-2222-a222-222222222222',
  warehouse: '22222222-2222-2222-a222-222222222223',
};

const PARTY = {
  acme: '33333333-3333-3333-a333-333333333331',
  euroGoods: '33333333-3333-3333-a333-333333333332',
  pacificRim: '33333333-3333-3333-a333-333333333333',
  shanghai: '33333333-3333-3333-a333-333333333334',
  brazil: '33333333-3333-3333-a333-333333333335',
};

const SHIP = {
  s1: '44444444-4444-4444-a444-444444444441',
  s2: '44444444-4444-4444-a444-444444444442',
  s3: '44444444-4444-4444-a444-444444444443',
  s4: '44444444-4444-4444-a444-444444444444',
  s5: '44444444-4444-4444-a444-444444444445',
};
